...
function SubscribersPage({ children }: { children: React.ReactNode }) {
  const { t } = useLanguage();
  return (
    <SidebarProvider>
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
        ...
        <div className="flex flex-col sm:gap-4 sm:py-4 md:pl-[--sidebar-width-icon] rtl:md:pr-[--sidebar-width-icon] rtl:md:pl-0 lg:pl-[--sidebar-width] rtl:lg:pr-[--sidebar-width] rtl:lg:pl-0">
            <PageHeader>
                ...
                <PageHeaderTitle>{t('header_subscribers')}</PageHeaderTitle>
...
const AuthenticatedSubscribersPage = withAuth(SubscribersPage);
export { AuthenticatedSubscribersPage as SubscribersPage };
